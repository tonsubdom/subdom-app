// // src/utils/miniAppLinks.ts
// import { publicUrl } from '../helpers/publicUrl';
// import { AuctionUrlParams, createAuctionUrl } from './urlParams';
...
//     const route = parts[0].startsWith('/') ? parts[0] : `/${parts[0]}`;
//     const params: Record<string, string> = {};
