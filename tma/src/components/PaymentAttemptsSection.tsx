...
//   // Функция для отображения таблицы попыток
//   const renderPaymentTable = (type: 'proxy' | 'sbt', data: Record<ZoneLength, boolean>) => {
...
//           }}>
//             {type === 'proxy' ? t('paymentAttemptsProxyZones') : t('paymentAttemptsSbtZones')}
//           </h4>
//           <div style={{ 
//             fontSize: '11px', 
//             color: colors.text,
...
//         }}>
//           <span>
//             {t('paymentAttemptsPaid')} <strong style={{ color: '#10B981' }}>
//               {Object.values(data).filter(v => v).length}
//             </strong> {t('paymentAttemptsOf')} 6
//           </span>
//           <span>
//             {t('paymentAttemptsAvailable')} <strong style={{ color: '#10B981' }}>
//               {Object.values(data).filter(v => v).length}
//             </strong>
//           </span>
//         </div>
