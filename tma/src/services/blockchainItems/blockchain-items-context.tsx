...
// import { NetworkType, ItemType, CollectionType } from './blockchain-items-types';
...
//   service: ReturnType<typeof selectService>;
...
//   // Утилиты
//   getCollectionsByType: (type: CollectionType) => ReturnType<typeof selectCollectionsByType>;
//   getItemsByType: (type: ItemType) => ReturnType<typeof selectItemsByType>;
//   getUserItemsByType: (type: ItemType) => ReturnType<typeof selectUserItemsByType>;
// }
...
//   const getCollectionsByType = useCallback((type: CollectionType) => {
//     return useSelector(selectCollectionsByType(type));
//   }, []);
  
//   const getItemsByType = useCallback((type: ItemType) => {
//     return useSelector(selectItemsByType(type));
//   }, []);
  
//   const getUserItemsByType = useCallback((type: ItemType) => {
//     return useSelector(selectUserItemsByType(type));
//   }, []);
...
//     }
//   }, [autoInitialize, service, initialize, defaultNetwork, apiKey]);
...
export const BlockchainItemsProvider: React.FC<BlockchainItemsProviderProps> = ({
  ...
  //     console.log('🚀 Автоматическая инициализация Blockchain сервиса...', {
  ...
  //   }
  // }, [autoInitialize, isServiceInitialized, initialize, resolvedNetwork, apiKey]);
  
  // // Обновление пользователя при изменении кошелька
  // useEffect(() => {
  //   if (wallet?.account?.address) {
  //     console.log('👤 Обновление адреса пользователя:', wallet.account.address);
  //     setCurrentUser(wallet.account.address);
  //   } else {
  //     console.log('👤 Сброс адреса пользователя (кошелек отключен)');
  //     setCurrentUser(null);
  //   }
  // }, [wallet, setCurrentUser]);
