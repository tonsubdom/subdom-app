...
//   // Извлекаем имя из метаданных или из домена
//   const name = tokenInfo.name || extractSubdomainName(item.content?.uri || '');
...
//     previews: extra ? [
//       {
//         url: extra._image_small || tokenInfo.image || '',
//         resolution: 'small'
//       },
//       {
//         url: extra._image_medium || tokenInfo.image || '',
//         resolution: 'medium'
//       },
//       {
//         url: extra._image_big || tokenInfo.image || '',
//         resolution: 'big'
//       }
//     ] : undefined,
...
// //   extractZoneName,
// //   convertToSimpleEnrichedItem,
// //   convertToSimpleCollection,
...
//     last_transaction_lt: item.last_transaction_lt,
//     // name, // ← ДОБАВИТЬ
//     // description: tokenInfo.description, // ← ДОБАВИТЬ
//     // image: tokenInfo.image // ← ДОБАВИТЬ
//   };
// };
