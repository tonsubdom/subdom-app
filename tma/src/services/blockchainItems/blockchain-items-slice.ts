...
//   // Сервис
//   service: UniversalBlockchainService | null;
// }
...
//       const service = state.blockchainItems.service;
...
//       // При смене сети сбрасываем сервис
//       state.service = null;
//     },
...
//       const { service, network } = action.payload;
...
// export const selectService = (state: { blockchainItems: BlockchainItemsState }) => 
//   state.blockchainItems.service;
...
//       console.log('🧪 Тестируем подключение сервиса...');
//       const testResult = await service.testConnection();
      
//       if (!testResult.success) {
//         throw new Error(`Ошибка подключения: ${testResult.message}`);
//       }
      
//       console.log('✅ Сервис инициализирован успешно');
