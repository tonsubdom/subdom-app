...
//    */
//   private static extractHashFromBoc(boc: string): string | null {
//     try {
...
//       // В продакшене используйте: import { Cell } from 'ton-core';
...
// /**
//  * Декоратор для транзакционных функций
//  */
// export function withTransactionVerification(
//   target: any,
//   propertyKey: string,
...
//     const tonConnectUI = this.tonConnectUI; // Предполагаем, что есть доступ к tonConnectUI
//     const network = this.isTestnet ? 'testnet' : 'mainnet';
    
//     // Вызываем оригинальный метод
//     const result = await originalMethod.apply(this, args);
    
//     if (result?.transactionResult?.boc) {
//       // Проверяем транзакцию
//       const verification = await TransactionService.waitForConfirmation(
//         TransactionService.extractHashFromBoc(result.transactionResult.boc) || '',
//         network,
//         30000
//       );
