...
itemFoundSuccessfully: 'Элемент успешно найден',
  ...
  createTorrentDropzoneHint: 'Любые файлы и архивы, несколько штук за раз. До 200 МБ на файл, до 50 файлов.',
  ...
  searchIndexAvatarSecret: 'Аватар / Секрет',
