...
itemFoundSuccessfully: 'Элемент успешно найден',
  ...
  tutorialBlock2SbtIntro: 'Здесь вы создадите SBT-субдомен, потратив вашу бесплатную попытку.',
  ...
  avatarSecretSubtitle: 'Блокчейн-профиль на домене — цифровая идентичность и функционал для доменов, субдоменов .ton и юзернеймов @ в Telegram. Загрузи аватар, категорию, описание прямо в txt записи домена',
